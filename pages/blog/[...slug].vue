<template>
    <main>
        <ContentDoc
            class="mx-auto mt-16 md:mt-32 prose !prose-stone !prose-invert prose-sm sm:prose lg:prose-lg xl:prose-lg mb-20 px-4 lg:px-12 bg-stone-900 py-10 rounded shadow">
            <template #not-found>
