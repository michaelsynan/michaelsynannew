<template>
  <div class="w-full flex flex-col justify-between text-white">
    <div class="text-left md:text-center text-5xl md:text-7xl font-bold mt-20 mb-10 w-11/12 md:w-2/3 mx-auto">
      L'ART DE LA RUE
    </div>
    <div class="flex justify-center">
      <div class="w-11/12 md:w-2/3">
        <div class="max-w-4xl mx-auto mb-14">
          <img src="/lart.webp" alt="Art Image" class="mx-auto  rounded-lg mb-4 md:mb-10">
