<template>
  <div class="w-full flex flex-col justify-between text-white">
    <div class="text-left text-5xl md:text-7xl font-bold mt-20 mb-10 w-11/12 md:w-2/3 mx-auto">
      BLDTogether
    </div>
    <div class="flex justify-center">
      <div class="w-11/12 md:w-2/3">
        <div class="max-w-4xl mx-auto mb-14">
          <img src="/home-dashboard.webp" alt="Art Image" class="mx-auto  rounded-lg mb-4 md:mb-10">
        ...
        <div class="max-w-4xl mx-auto mb-14">
          <h2 class="text-3xl font-bold tracking-wide uppercase mb-4 border-b-2 border-stone-700">About This Project
          </h2>
        ...
        <div class="max-w-4xl mx-auto mb-14">
          ...
          <p class="text-lg md:text-xl tracking-wide">
            Dortmund's bold and geometric characteristics mirror the distinctive style of the jewelry, making it an
            ideal
          ...
          <h3 class="text-2xl opacity-50 font-bold tracking-wide uppercase mt-8">Fonts used</h3>
          <div class="">
          ...
          <h3 class="text-2xl opacity-50 font-bold tracking-wide uppercase mt-8 mb-2">Colors</h3>
          <p class="text-lg md:text-xl tracking-wide">
            Rich, earthy tones of orange and green are used to evoke the natural elements of the jewelry, while the
            black
          ...
          <div class="flex space-x-4 mt-6 mb-10">
        ...
        <div class="max-w-4xl mx-auto mb-32">
          <nuxt-link target="_blank" to="https://lart-formwork-studios.vercel.app/" id="link1"
            ...
            Visit Site <i-mdi-arrow-top-right class="inline ml-1  text-xl -mr-1" />
          </nuxt-link>
        </div>
      </div>
    </div>
